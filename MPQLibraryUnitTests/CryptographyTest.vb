...
Public Class CryptographyTest
    ...
    Public Sub HashStringTest()
        Assert.IsTrue(HashString("filename", CryptTableIndex.CipherKeyHash) = 656171036UI)
    ...
    Public Sub BreakFileDecryptionKeyTest()
        Assert.IsTrue(0 = BreakFileDecryptionKey(encryptedValue1:=New Byte() {132, 150, 44, 15}.ToUInt32,
                                                 encryptedValue2:=New Byte() {159, 18, 221, 43}.ToUInt32,
                                                 plainValue1:=New Byte() {2, 3, 5, 7}.ToUInt32))
    End Sub
End Class
