...
Public Class StreamCypherTest
    ...
    Public Sub EncryptTest_FromPrimes()
        ...
        Call New MPQ.Cryptography.EncypherStream(output.AsWritableStream, 0).Write(primes)
        output.Position = 0
    ...
    Public Sub DecryptTest_FromPrimes()
        ...
        Dim output = New MPQ.Cryptography.DecypherStream(input, 0).ReadRemaining
    ...
    Public Sub EncryptTest_ToPrimes()
        Dim output = New IO.MemoryStream()
        Call New MPQ.Cryptography.EncypherStream(output.AsWritableStream, 0).Write(New Byte() {132, 150, 44, 15, 159, 18, 221, 43, 159, 190, 179}.AsReadableList)
        output.Position = 0
